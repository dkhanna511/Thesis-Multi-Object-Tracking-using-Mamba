...
def main(exp, args, num_gpu):
    ...
    print(" model name is : ", args.model_type)
    # exit(0)
    model = exp.get_model()
    # print(" model is : ", model) ### i guess this takes in the YOLOX model to give detections
    print("image size mentioned is ", exp.test_size)
    # exit(0)
...
if __name__ == "__main__":
    ...
    print(" numbwer of gpus is : ", num_gpu)
