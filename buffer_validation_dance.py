...
parameter_sets = [
    ...
    # {'association' : 'diffmot_without_virtual', 'model_type' : 'attention-mamba', 'max_window': 15, 'num_blocks' : 4, 'b1' : 0.25, 'b2': 0.25},
    # {'association' : 'diffmot_without_virtual', 'model_type' : 'attention-mamba', 'max_window': 15, 'num_blocks' : 4, 'b1' : 0.25, 'b2': 0.3},
    # {'association' : 'diffmot_without_virtual', 'model_type' : 'attention-mamba', 'max_window': 15, 'num_blocks' : 4, 'b1' : 0.25, 'b2': 0.35},
    # {'association' : 'diffmot_without_virtual', 'model_type' : 'attention-mamba', 'max_window': 15, 'num_blocks' : 4, 'b1' : 0.25, 'b2': 0.4},
    # {'association' : 'diffmot_without_virtual', 'model_type' : 'attention-mamba', 'max_window': 15, 'num_blocks' : 4, 'b1' : 0.25, 'b2': 0.45},
    # {'association' : 'diffmot_without_virtual', 'model_type' : 'attention-mamba', 'max_window': 15, 'num_blocks' : 4, 'b1' : 0.30, 'b2': 0.25},
    # {'association' : 'diffmot_without_virtual', 'model_type' : 'attention-mamba', 'max_window': 15, 'num_blocks' : 4, 'b1' : 0.30, 'b2': 0.3},
    # {'association' : 'diffmot_without_virtual', 'model_type' : 'attention-mamba', 'max_window': 15, 'num_blocks' : 4, 'b1' : 0.30, 'b2': 0.35},
    # {'association' : 'diffmot_without_virtual', 'model_type' : 'attention-mamba', 'max_window': 15, 'num_blocks' : 4, 'b1' : 0.30, 'b2': 0.4},
    # {'association' : 'diffmot_without_virtual', 'model_type' : 'attention-mamba', 'max_window': 15, 'num_blocks' : 4, 'b1' : 0.30, 'b2': 0.45},
    # {'association' : 'diffmot_without_virtual', 'model_type' : 'attention-mamba', 'max_window': 15, 'num_blocks' : 4, 'b1' : 0.35, 'b2': 0.25},
    # {'association' : 'diffmot_without_virtual', 'model_type' : 'attention-mamba', 'max_window': 15, 'num_blocks' : 4, 'b1' : 0.35, 'b2': 0.3},
    # {'association' : 'diffmot_without_virtual', 'model_type' : 'attention-mamba', 'max_window': 15, 'num_blocks' : 4, 'b1' : 0.35, 'b2': 0.35},
    # {'association' : 'diffmot_without_virtual', 'model_type' : 'attention-mamba', 'max_window': 15, 'num_blocks' : 4, 'b1' : 0.35, 'b2': 0.4},
    # {'association' : 'diffmot_without_virtual', 'model_type' : 'attention-mamba', 'max_window': 15, 'num_blocks' : 4, 'b1' : 0.35, 'b2': 0.45},
    # {'association' : 'diffmot_without_virtual', 'model_type' : 'attention-mamba', 'max_window': 15, 'num_blocks' : 4, 'b1' : 0.40, 'b2': 0.25},
    # {'association' : 'diffmot_without_virtual', 'model_type' : 'attention-mamba', 'max_window': 15, 'num_blocks' : 4, 'b1' : 0.40, 'b2': 0.30},
    # {'association' : 'diffmot_without_virtual', 'model_type' : 'attention-mamba', 'max_window': 15, 'num_blocks' : 4, 'b1' : 0.40, 'b2': 0.35},
    # {'association' : 'diffmot_without_virtual', 'model_type' : 'attention-mamba', 'max_window': 15, 'num_blocks' : 4, 'b1' : 0.40, 'b2': 0.40},
    # {'association' : 'diffmot_without_virtual', 'model_type' : 'attention-mamba', 'max_window': 15, 'num_blocks' : 4, 'b1' : 0.40, 'b2': 0.45},

    # {'association' : 'diffmot_without_virtual', 'model_type' : 'attention-mamba', 'max_window': 15, 'num_blocks' : 4, 'b1' : 0.0, 'b2': 0.0},
    
    
    
    ###  Best performed for Height modulated IoU
    {'association' : 'diffmot_without_virtual', 'model_type' : 'attention-mamba', 'max_window': 15, 'num_blocks' : 4, 'b1' : 0.40, 'b2': 0.25}
    # {'association' : 'diffmot', 'model_type' : 'attention-mamba', 'max_window': 15, 'num_blocks' : 4, 'b1' : 0.3, 'b2': 0.4}
    
    # {'association' : 'diffmot_without_virtual', 'model_type' : 'attention-mamba', 'max_window': 15, 'num_blocks' : 4, 'b1' : 0.30, 'b2': 0.40}

    # Add more parameter sets as needed
    # {'association' : 'diffusion', 'model_type' : 'attention-mamba', 'max_window': 15, 'num_blocks' : 4, 'b1' : 0.40, 'b2': 0.25}
...
for i, params in enumerate(parameter_sets):
    ...
    # model_name = "dancetrack_ablations/best_model_bbox_dancetrack_variable_attention-mamba_max_window_{}_num_blocks_{}.pth".format(params['max_window'], params['num_blocks'], params['b1'], params['b2'])
    ...
    print(" buffer sizes are : {}, and {}".format(params['b1'], params['b2']))
    ...
    # experiment_dir = "YOLOX_outputs/{}".format(experiment_folder)
    shutil.move("combined_output_data.csv", final_output_dir)
