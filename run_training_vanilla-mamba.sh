...
args1="--dataset MOT20 --model_type vanilla-mamba --save_model --epochs 50 --run_wandb"
args2="--dataset dancetrack --model_type vanilla-mamba --save_model --epochs 50 --run_wandb"
# args3="arg1_for_script3 arg2_for_script3"

# Run the first Python script with its arguments
echo "Running train_mot20_bbox.py with arguments: $args1"
...
echo "Running train_dancetrack_bbox.py with arguments: $args2"
