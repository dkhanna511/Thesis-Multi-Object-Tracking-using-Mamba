...
def main():
    ...
    ## Define the dataset
    dataset_train_bbox = MOTDatasetBB(path='datasets/dancetrack/train', window_size = window_size, max_window = args.max_window, augment = augment, augment_ratio = augment_ratio )
    dataset_val_bbox = MOTDatasetBB(path="datasets/dancetrack/val", window_size = window_size, max_window = args.max_window,  augment = False)
